...
public class Client extends JFrame {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    JLabel hostlLabel = new JLabel("Host");
                    JTextField hostfField = new JTextField(10);
                    hostfField.setText("localhost");
                    JButton sub = new JButton("Submit");
                    start.add(portlLabel);
                    start.add(portTextField);
                    start.add(namelLabel);
                    start.add(nameField);
                    start.add(hostlLabel);
                    start.add(hostfField);
                    start.add(sub);
                    start.setSize(150, 180);
                    ...
                    sub.addActionListener(new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent actionEvent) {
                            ...
                            host = hostfField.getText();
                            try {
                                start.setVisible(false);
                                Client frame = new Client(port, host, name);
     ...
     * Create the frame.
     */
    public Client(int port, String serverName, String name) throws IOException, ClassNotFoundException {
